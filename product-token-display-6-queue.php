        ...
        <div class="product-info">
            <div class="product-header">
                ...
                <div class="product-actions" style="margin-top: 1.5rem; display: flex; gap: 1rem; flex-wrap: wrap;">
                    <button onclick="addProductToCart('token-display-6-queue', '<?php echo htmlspecialchars($product['name'], ENT_QUOTES); ?>', <?php echo $product['base_price']; ?>, '<?php echo htmlspecialchars($product['images'][0]['url'], ENT_QUOTES); ?>', 'FBXQMS6')" 
