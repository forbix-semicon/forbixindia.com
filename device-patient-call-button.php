<?php
$pageTitle = "Patient Call Button System - FORBIX SEMICON® Healthcare Technology";
      ...
      <div class="header-section">
        <div>
          ...
          <div class="brand-info">
            <h3>FORBIX SEMICON® Wireless Nurse Call System</h3>
        ...
        <div class="image-gallery">
          <div class="featured-image">
            <img src="assets/images/gallery/nurse-call/forbix-semicon-nurse-call-patient-remote-control.jpg" 
                 alt="FORBIX SEMICON® Patient Call Button Remote Control" />
          </div>
