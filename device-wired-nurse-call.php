<?php
$pageTitle = "Wired Nurse Call System - FORBIX SEMICON® Healthcare Technology";
      ...
      <div class="header-section">
        <div>
          ...
          <div class="brand-info">
            <h3>FORBIX SEMICON® Wired Nurse Call System</h3>
      ...
      <div class="comp-card">
        ...
        <div class="btn-group">
          ...
          <a href="https://youtu.be/18TvqpiIih4" target="_blank" class="btn-secondary">
            <span>▶️</span> Video: Wired Nurse Call
          </a>
        ...
        <div class="image-gallery">
          <div class="featured-image">
            <img src="assets/images/gallery/nurse-call/forbix-semicon-wired-nurse-station-indicator-console.jpg" 
                 alt="FORBIX SEMICON® Wired Nurse Station Indicator Console" />
          </div>
          <div class="thumbnail-grid">
            <div class="thumbnail active">
              <img src="assets/images/gallery/nurse-call/forbix-semicon-wired-nurse-station-indicator-console.jpg" 
                   alt="FORBIX SEMICON® Wired Nurse Station Console" />
            </div>
            <div class="thumbnail">
              <img src="assets/images/gallery/nurse-call/forbix-semicon-wired-nurse-station-indicator-wiring.jpg" 
                   alt="FORBIX SEMICON® Wired Station Indicator Wiring" />
            </div>
            <div class="thumbnail">
              <img src="assets/images/gallery/nurse-call/forbix-semicon-wired-attendant-calling-system.jpg" 
                   alt="FORBIX SEMICON® Wired Attendant Calling System" />
            </div>
          </div>
        </div>
